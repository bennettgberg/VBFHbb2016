...
#./mkTransferFunctions_run2_cat.py --workdir=test_for_bennett --TF ConstPOL1,ConstPOL1
#./mkSigTemplates_run2_cat.py --workdir=test_for_bennett
#./mkBkgTemplates_run2_cat.py --workdir=test_for_bennett  
#./mkDataTemplates_run2_cat.py --workdir=test_for_bennett --TF ConstPOL1,ConstPOL1
for i in $(seq 1 8)
do
  echo "Running Pol$i"
